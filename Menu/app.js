...
// function to add menu items to html ..

function displayMenuItems(menuItems) {
  let menu = menuItems.map(function(item) {
...
/// function to add btns dynamically to directly html through Javascript

function displayMenuBtns() {
  const categories = menu.reduce(function(value, items) {
